      ...
      <div className="login-left">
        ...
        <div
          style={{
            ...
            height: 500,
            borderRadius: "50%",
            background: "rgba(124,184,168,0.07)",
            pointerEvents: "none",
          }}
        />
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div
            style={{
              ...
              border: "1px solid rgba(124,184,168,0.3)",
              borderRadius: 20,
              padding: "6px 14px",
              marginBottom: 28,
            }}
          ...
          >
            Vos biens affichés
            <br />
            en <span style={{ color: "#7CB8A8" }}>mensualités.</span>
          </h2>
          ...
          >
            Connectez-vous pour gérer vos biens, vos widgets et suivre vos
            leads.
          </p>
        ...
        <div className="login-content">
          <div
            ...
            style={{
              ...
              padding: "40px 32px",
              borderRadius: 18,
              boxShadow: "0 4px 24px rgba(22,50,79,0.06)",
          ...
          >
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              >
                Accédez à votre espace promoteur
              </p>
            </div>
            ...
            >
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    onFocus={(e) =>
                      (e.target.style.borderColor = "#7CB8A8")
                    }
                    onBlur={(e) =>
              ...
              <button
                ...
                style={{
                  width: "100%",
                  background: loading ? "#E8EDF2" : "#193B5E",
