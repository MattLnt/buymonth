...
export default async function ClientDashboard() {
  ...
  const kpis = [
    { label: 'Biens actifs', value: nbBiensActifs, sub: `${nbBiens} au total`, icon: 'building', grad: 'linear-gradient(135deg, #16324F 0%, #2E6388 100%)', href: '/dashboard/client/biens' },
    { label: 'Biens en option', value: nbBiensOption, sub: `${nbBiensFactures} facturés`, icon: 'tag', grad: 'linear-gradient(135deg, #B4791C 0%, #E89923 100%)', href: '/dashboard/client/biens' },
