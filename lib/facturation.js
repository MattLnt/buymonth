...
// Montant mensuel = nb de biens ACTIFS × tarif de la formule.
// + frais de mise en service uniques (une seule fois).
// Le widget est gratuit (plus de paiement à l'unité).

export const TARIFS = {
  PRO: 39, // € HTVA / bien actif / mois
  PRO_PLUS: 45, // € HTVA / bien actif / mois
}
...
// Seul un bien ACTIF est facturé. option / hors-ligne / vendu => hors décompte.
export function estBienFacturable(bien) {
  return bien?.statut === 'ACTIF'
}
